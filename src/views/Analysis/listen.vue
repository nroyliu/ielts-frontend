					...
					<div class="answers">
						<div class="myAnswer">
							...
							<div style="display:flex;flex-wrap: wrap;margin-top: 10px;">
								<span style="margin-right: 10px" class="wrong">
									<b>1.</b>
									qwe
								</span>
								<span style="margin-right: 10px" class="wrong">
								...
								<span style="margin-right: 10px" class="wrong"><b>3.</b></span>
								<span style="margin-right: 10px" class="wrong"><b>4.</b></span>
								<span style="margin-right: 10px" class="wrong"><b>5.</b></span>
								<span style="margin-right: 10px" class="wrong"><b>6.</b></span>
							</div>
						</div>
						<div class="Answer">
							<div>正确答案：</div>
...
<script>
import { getListenAnalize } from '@/server/api'
